                                  ...
                                  <ul>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu agile_short_dropdown">
                                            ...
                                            <li class="active"><a href="10kmmarathon.php" class="w3_icon_1">10KM Marathon</a></li>
...
<!-- about -->
	<div class="about">
		<div class="container">
			...
			<img src="images/maps/10km.jpg">
			<a href="images/maps/10km.jpg" download><button class="button button1">Download Map</button></a>
		</div>
	</div>
<!-- //about -->
...
<script>
	$(document).ready(function (){
		$("#gauge1").gauge(30,{color: "#ef3708",unit: " %",type: "halfcircle"});
