...
<div class="container" id="payment-container">
   ...
   <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
        <!-- Load item from localstorage  here -->
        <table>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Race</b></td>
                <td><?php echo $_SESSION['raceCategories']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Distance</b></td>
                <td><?php echo $_SESSION['raceDistance']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Date</b></td>
                <td><?php echo $_SESSION['raceDate']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Recommended Arrival Time </b></td>
                <td><?php echo $_SESSION['arrivalTime']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
            ...
            <tr class="w3-light-grey w3-hover-red">
                ...
                <td><?php echo $_SESSION['minAge']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Cut Off Time</b></td>
                <td><?php echo $_SESSION['raceCutOffTime']; ?></td>
            </tr>
            <tr class="w3-light-grey w3-hover-red">
                <td><b>Payment Summary</b></td>
                <td><?php echo $_SESSION['racePrice']; ?></td>
            </tr>
        </table>
        <!-- Load item from localstorage  here -->            
    </div>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="php/payment.php" name="paymentForm" role="form" method="POST" onsubmit="return validateForm()">

                            <input type='hidden' id= 'price' name='price' value='' />
                            <input type='hidden' id= 'raceCategory' name='raceCategory' value='' />
                            <input type='hidden' id= 'distance' name='distance' value='' />
                            <input type='hidden' id= 'minimumAge' name='minimumAge' value='' />
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="cardNumber" id="cardNumber" placeholder="Valid Card Number" required autofocus />
                                ...
                                <div class="col-xs-7 col-md-7">
                                    ...
                                    <div class="col-xs-5 col-md-5 pull-right">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="cvCode" id="cvCode" placeholder="CV" required />
                                        </div>
                                    </div>
                                </div>
                                <br/>
                                <!-- <button data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg btn-block" role="button">Pay</button> -->
                                <button type="submit" class="btn btn-success btn-lg btn-block" name="payment" role="button">Pay</button>
                            </form>
                        </div>
                    </div>
                </div>
