                                  ...
                                  <ul>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu agile_short_dropdown">
                                            ...
                                            <li class="active"><a href="fullmarathon.php" class="w3_icon_1">Full Marathon</a></li>
...
<!-- about -->
	<div class="about">
		<div class="container">
			...
			<img src="images/maps/42km.jpg">
			<a href="images/42km.jpg" download><button class="button button1">Download Map</button></a>
		</div>
	</div>
<!-- //about -->
