				...
				if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
					...
					if ($resultCheck > 0) {
						...
						$forgotpwcode = rand(12345,123456);
                              $sql = "INSERT INTO users (fname,lname,idno,age,email,password,finding,confirmcode,forgetpwcode) VALUES ('$firstname','$lastname','$identificationNo','$age','$email','$hashedPwd','$confirmcode','$forgotpwcode');";
